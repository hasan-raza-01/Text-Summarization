...
class ModelTrainerConstants:
    ARITFACTS_ROOT_DIR_NAME = CONFIG.ARITFACTS_ROOT_DIR_NAME
    MODEL_TRAINER_ROOT_DIR_NAME = CONFIG.MODEL_TRAINER.ROOT_DIR_NAME
    BASE_ESTIMATOR_NAME = CONFIG.MODEL_TRAINER.BASE_ESTIMATOR_NAME
    FINETUNED_ESTIMATOR_NAME = CONFIG.MODEL_TRAINER.FINETUNED_ESTIMATOR_NAME
    PARAMS_FILE_NAME = CONFIG.MODEL_TRAINER.PARAMS_FILE_NAME
